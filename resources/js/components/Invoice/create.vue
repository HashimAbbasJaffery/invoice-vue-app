    ...
    <div class="container">
        ...
        <div class="card__content">
            <div class="card__content--header">
                ...
                <div>
                    <p class="my-1">Date</p> 
                    <input id="date" placeholder="dd-mm-yyyy" v-model="form.date" type="date" class="input"> <!---->
            ...
            <div class="table">
                ...
                <!-- item 1 -->
                <div class="table--items2" v-for="(itemcart, i) in listCart" v-if="listCart.length" :key="itemcart.id">
